...
<form onsubmit="return adminregcust()" action="${pageContext.request.contextPath}/registerCustomerServlet" method="post">
  <div class="container">
	...
	<label for="retailerSelector"><b>Select Retailer</b></label><br>
    ...
    <label for="customerCreateDate"><b>Customer Created on</b></label><br>
    <input type="text" id="demo"  name="created_on" disabled="disabled"><br><br>
