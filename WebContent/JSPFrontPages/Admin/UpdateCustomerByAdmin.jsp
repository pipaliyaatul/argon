...
<form onsubmit="return adminregcust()"   action="${pageContext.request.contextPath}/updateCustomerServlet?id=${customer.customer_id}" method="post">
<fieldset>

  <div class="container">
  
  <h1 style="text-align:center"><legend>Update Infinity Customer Details</legend></h1>
    ...
    <input type="text" placeholder="Enter Email Id" name="email_id" value="${customer.email_id}" id="a_r_c_email" onchange="admin_update_retailer()" required><br><br>
...
<!--     <label for="OpName"><b>Operator Name</b></label><br>
    <select name="">
	<option value="c1">Operator 1</option>
	<option value="c2">Operator 2</option>
	<option value="c3">Operator 3</option>
	<option value="c4">Operator 4</option>
	</select>
    <br><br>
   <label for="RetailerName"><b>Retailer Name</b></label><br>
	...
	<option value="r3">Retailer 3</option>
	<option value="r4">Retailer 4</option>
	</select>
   <br><br>
	 -->
    <button type="submit" class="registerbtn" onclick="return confirm('Are you sure you want to continue?')">Update Details</button><br>
  </div>
