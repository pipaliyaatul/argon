	...
	<c:forEach var="customer" items="${customerList}">
	  	   <tr>
			  ...
			  <td>
			    ...
			    <a href="${pageContext.request.contextPath}/CustomerAssignServlet?id=${customer.customer_id}&action=retailer" onclick="return confirm('Are you sure you want to continue?')">Assign Retailer</a>
			  </td>  
